...
DAG_ID = "BRONZE__MINIO__NYTAXI-TRIP"
...
with DAG(
    ...
    export_minio_task = SparkSubmitOperator(
        ...
        application="/opt/airflow/spark-jobs/pyspark/extract/minio/parquet.py",
        ...
        application_args=[
            str(
                {
                    "save_path": "s3a://data-platform-core/bronze/NYTaxiTrip",
                    "output_path": "s3a://raw-data/NYTaxiTrip",
                    "strategy": "overwrite",
                    "hive_ctlg": "spark_catalog",
                    "hive_db": "bronze",
                    "hive_table": "ny_taxi_trip",
                }
            )
        ],
        verbose=True,
